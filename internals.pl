...
$key = q/fig:FloatingPointMultiplication/;
...
$key = q/fig:storeProgram/;
$ref_files{$key} = "$dir".q|node23.html|; 
$noresave{$key} = "$nosave";

$key = q/fig:floatingPointAddHardware/;
...
$key = q/fig:responsetime2/;
$ref_files{$key} = "$dir".q|node75.html|; 
$noresave{$key} = "$nosave";

$key = q/fig:binaryFloatAdd/;
$ref_files{$key} = "$dir".q|node63.html|; 
$noresave{$key} = "$nosave";
...
$key = q/fig:insideDesktop/;
$ref_files{$key} = "$dir".q|node7.html|; 
$noresave{$key} = "$nosave";

$key = q/fig:conditionalB/;
...
$key = q/fig:airAnalogy/;
$ref_files{$key} = "$dir".q|node73.html|; 
$noresave{$key} = "$nosave";

$key = q/fig:softwareCompiler/;
$ref_files{$key} = "$dir".q|node7.html|; 
$noresave{$key} = "$nosave";
